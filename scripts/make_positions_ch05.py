...
POSITIONS = {
    ...
    "ch05_ex1": dict(
        AB=b1, AW=w1,
        # 只標提點。【不要】在 victim1（D5）上放標籤 —— 那一點有白子，
        # 而 render_ascii 的標籤會把棋子蓋掉，讀者會看到一個空的 D5，
        # 於是「黑下 a 提子」變得沒有東西可提。
        LB={kopt1: "a"},
        comment="練習 5.1：黑下 a（E5）提掉白 D5 之後，白【不能】立刻回提 D5。"
                "但白可以下別的地方。請說出：白下完別處、黑應了之後，"
                "白能不能回提 D5？"
                "三種規則（基本劫規、positional、situational）的答案一樣嗎？",
    ),
    "ch05_ex2": dict(
        AB=tri_b, AW=tri_w,
        comment="練習 5.3：這個三劫盤面，在 situational superko 之下，"
